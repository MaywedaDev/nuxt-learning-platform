<template>
    <v-container class="mb-16">
        ...
        <v-btn-group style="overflow-x: scroll;" :rounded="0" class="text-none">
        ...
        <v-card class="pa-8 py-10" :rounded="0" variant="outlined">
            ...
            <p style="max-width: 600px"  class=" mb-3">Take one of NuxtLearn’s range of Python courses and learn how to code using this incredibly useful language. Its simple syntax and readability makes Python perfect for Flask, Django, data science, and machine learning. You’ll learn how to build everything from games to sites to apps. Choose from a range of courses that will appeal to</p>
            <v-btn :height="40" variant="outlined" :rounded="0" class="text-none mb-6 text-body-1">Explore Python</v-btn>
            <div class="d-flex ga-4 w-100" style="overflow: scroll;" >
...
<script setup lang="ts">
    ...
    },
    {
        ...
        "instructor": "Jose Portilla, Pienan Training",
        "rating": "4.6★★★★★",
        "reviews": "(146,340)",
        "price": "₦41,900"
    },
    {
        ...
        "instructor": "Dieu Niewal, Ritu Antil",
        "rating": "4.3★★★★★",
        "reviews": "(1385)",
        "price": "₦31,900"
    }];
